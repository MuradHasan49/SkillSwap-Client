...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("py-1.5 pr-2 pl-3 text-xs font-semibold text-muted-foreground", className)}
      {...props} />
  );
}
